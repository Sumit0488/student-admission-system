...
import { Plus, Search, Users, X, SlidersHorizontal, Mail, MessageCircle, Download } from 'lucide-react';
import { getGeneralStudents, createGeneralStudent } from '../../services/generalApi';
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="px-5 py-4 space-y-3">
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t border-gray-100 dark:border-slate-700">
            ...
            <button type="submit" disabled={saving} className="px-4 py-2 text-sm font-semibold bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors">{saving ? 'Saving...' : 'Add Student'}</button>
          </div>
        </form>
      </div>
    </div>
