...
const billingOrderSchema = new mongoose.Schema(
  {
    ...
    entity: { type: String, required: true, trim: true, default: 'billing_order' },
    ...
    term: { type: Number },
    student_id: { type: mongoose.Schema.Types.ObjectId, ref: 'BillingCustomer' },
...
const BillingOrder = mongoose.model('BillingOrder', billingOrderSchema);
